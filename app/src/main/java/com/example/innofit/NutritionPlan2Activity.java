...
public class NutritionPlan2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            private void openDashboard(View view) {
                Intent intent = new Intent(NutritionPlan2Activity.this, Profile.class);
        ...
        todolist.setOnClickListener(new View.OnClickListener() {
            ...
            private void openTodolist(View view) {
                Intent intent = new Intent(NutritionPlan2Activity.this, ProgressTrackerActivity.class);
                startActivity(intent);
            }
        });
        ...
        nutrition.setOnClickListener(new View.OnClickListener() {
            ...
            private void openNutrition(View view) {
                Intent intent = new Intent(NutritionPlan2Activity.this, NutritionStartActivity.class);
                startActivity(intent);
            }
        });
    }
