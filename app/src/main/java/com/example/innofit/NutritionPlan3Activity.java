...
public class NutritionPlan3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutrition_plan3);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            private void openDashboard(View view) {
                Intent intent = new Intent(NutritionPlan3Activity.this, Profile.class);
        ...
        todolist.setOnClickListener(new View.OnClickListener() {
            ...
            private void openTodolist(View view) {
                Intent intent = new Intent(NutritionPlan3Activity.this, ProgressTrackerActivity.class);
                startActivity(intent);
            }
        });
        ...
        nutrition.setOnClickListener(new View.OnClickListener() {
            ...
            private void openNutrition(View view) {
                Intent intent = new Intent(NutritionPlan3Activity.this, NutritionStartActivity.class);
                startActivity(intent);
            }
        });
    }
